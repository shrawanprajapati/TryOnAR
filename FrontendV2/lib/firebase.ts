...
if (missingKey) {
  console.warn(`Missing Firebase config value: ${missingKey}. Add it to FrontendV2/.env and restart Expo.`);
}
...
function getAuthErrorMessage(error: unknown) {
  ...
  switch (code) {
    ...
    case 'auth/api-key-not-valid':
      return 'Your Firebase web app config is invalid. Update FrontendV2/.env and restart Expo with a cleared cache.';
    default:
