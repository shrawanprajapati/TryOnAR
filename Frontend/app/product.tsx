...
import { buildViewerUrl, fetchProduct, formatPrice, type CatalogProduct } from '../lib/api';
...
export default function ProductScreen() {
  ...
  const handleOpenViewer = async () => {
    try {
      ...
      Alert.alert('Viewer unavailable', 'The AR preview page could not be opened right now.');
    }
  };
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TouchableOpacity style={[styles.button, { backgroundColor: accent }]} onPress={handleContinue}>
        <Text style={styles.buttonText}>
          {isPlacementFlow ? 'Detect & Place in AR' : 'Start Try-On Flow'}
        </Text>
      </TouchableOpacity>
