...
export default function HomeScreen() {
  ...
  const workspaceTools = [
    { id: '1', name: 'My Models', icon: 'cube-outline', sub: 'Backend-synced AR objects', route: '/models' },
    { id: '2', name: 'Placement Guide', icon: 'scan-outline', sub: 'Scan a room and anchor objects live', route: '/placement' },
    { id: '3', name: 'AR Ruler', icon: 'options-outline', sub: 'Use camera alignment tips for spaces', route: '/ruler' },
    { id: '4', name: 'Snapshots', icon: 'images-outline', sub: 'Saved sessions from your workspace', route: '/snapshots' },
  ];
      ...
      <PageTransition>
        ...
        <TouchableOpacity style={[styles.envCard, glassCard]} onPress={() => handlePress('TRY LENS')}>
          ...
          <View style={{ flex: 1, marginLeft: 15 }}>
            ...
            <Text style={{ color: theme.subText, fontSize: 13, marginTop: 2 }}>Run live try-on or process a gallery image through the connected AI flow.</Text>
          </View>
        ...
        <TouchableOpacity style={[styles.envCard, glassCard, { marginTop: 0 }]} onPress={() => handlePress('DETECT OBJECT')}>
          ...
          <View style={{ flex: 1, marginLeft: 15 }}>
            ...
            <Text style={{ color: theme.subText, fontSize: 13, marginTop: 2 }}>Analyze a room or object, then launch the live placement viewer.</Text>
          </View>
          <Ionicons name="chevron-forward" size={24} color={theme.subText} />
        </TouchableOpacity>
