...
export default function ProfileScreen() {
  ...
  const profileOptions = [
    ...
    { id: '2', title: 'AR Preferences', icon: 'scan-outline', route: '/tryon' },
    { id: '3', title: 'App Settings', icon: 'settings-outline', route: '/settings' },
    { id: '4', title: 'Help & Support', icon: 'help-circle-outline', route: '/settings' },
  ];
  ...
  }, [isAuthenticated, isReady, refreshProfile]);
